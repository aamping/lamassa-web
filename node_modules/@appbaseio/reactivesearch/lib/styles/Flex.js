...
var border = /*#__PURE__*/(0, _emotion.css)('border:1px solid #ccc;');
...
}, ';svg.cancel-icon{cursor:pointer;fill:', function (props) {
	return (0, _utils.shade)(props.theme.textColor, 0.3);
}, ';flex-basis:30px;&:hover{fill:', function (props) {
