...
var ResultList = function (_Component) {
	...
	ResultList.prototype.componentWillReceiveProps = function componentWillReceiveProps(nextProps) {
	...
	ResultList.prototype.componentWillUnmount = function componentWillUnmount() {
	...
	ResultList.prototype.render = function render() {
		...
		return _react2.default.createElement(
			...
			_react2.default.createElement(
				'div',
				{ className: _ListItem.container + ' ' + (0, _helper.getClassName)(this.props.innerClass, 'list') },
				[].concat(streamResults, filteredResults).map(function (item) {
					return _this2.renderAsListItem(item);
				})
			),
...
var _initialiseProps = function _initialiseProps() {
	...
	this.renderAsListItem = function (item) {
