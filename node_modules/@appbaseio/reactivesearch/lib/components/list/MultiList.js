		...
		return _react2.default.createElement(
			...
			_react2.default.createElement(
				...
				selectAllLabel ? _react2.default.createElement(
					...
					_react2.default.createElement(
						'label',
						{ className: (0, _helper.getClassName)(this.props.innerClass, 'label') || null, htmlFor: selectAllLabel },
						selectAllLabel
					)
				) : null,
				this.state.options.filter(function (item) {
					...
					return _react2.default.createElement(
						...
						_react2.default.createElement(
							'label',
							{ className: (0, _helper.getClassName)(_this3.props.innerClass, 'label') || null, htmlFor: item.key },
							item.key,
...
exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchtoProps)(MultiList);