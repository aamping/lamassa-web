				...
				this.props.data.map(function (item) {
					return _react2.default.createElement(
						'li',
						{
							role: 'menuitem',
							tabIndex: '0',
							className: _this3.state.currentValue && _this3.state.currentValue.start === item.start ? 'active' : '',
							onClick: function onClick() {
								return _this3.setValue(item);
							},
...
exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchtoProps)(RatingsFilter);