...
class UserProfileScreen extends Component {
  ...
  onClickEditar(e, value) {
    this.setState({ open: true, detall: e.nativeEvent.target.id, value });
    // console.log(this.props.user.find(obj=> obj === value));
  }

  render() {
    const { avatar, bio, carrer, invitacions, lloc_entrega, numero, phone_number, pis, poblacio, user } = this.props;
                ...
                <TableBody>
                  <TableRow>
                    ...
                    <TableCell className="userprofile-editar">
                      <a id="Nom" onClick={e => this.onClickEditar(e, user.first_name)}>
                        Editar
                      </a>
                    </TableCell>
                  </TableRow>
                  <TableRow>
                    ...
                    <TableCell className="userprofile-editar">
                      <a id="Cognoms" onClick={e => this.onClickEditar(e, user.last_name)}>
                        Editar
                      </a>
                    </TableCell>
                  </TableRow>
                  <TableRow>
                    ...
                    <TableCell className="userprofile-editar">
                      <a id="Nom usuari/a" onClick={e => this.onClickEditar(e, user.username)}>
                        Editar
                      </a>
                    </TableCell>
                  </TableRow>
                  <TableRow>
                    ...
                    <TableCell className="userprofile-editar">
                      <a id="Correu electronic" onClick={e => this.onClickEditar(e, user.email)}>
                        Editar
                      </a>
                    </TableCell>
                  </TableRow>
                  <TableRow>
                    ...
                    <TableCell className="userprofile-editar">
                      <a id="Telèfon" onClick={e => this.onClickEditar(e, phone_number)}>
                        Editar
                      </a>
                    </TableCell>
                  </TableRow>
                  <TableRow>
                    ...
                    <TableCell className="userprofile-editar">
                      <a id="Direcció" onClick={e => this.onClickEditar(e, direccio)}>
                        Editar
                      </a>
                    </TableCell>
                  </TableRow>
                  <TableRow>
                    ...
                    <TableCell className="userprofile-editar">
                      <a id="Població" onClick={e => this.onClickEditar(e, poblacio)}>
                        Editar
                      </a>
                    </TableCell>
                  </TableRow>
                  <TableRow>
                    ...
                    <TableCell className="userprofile-editar">
                      <a id="Descripció" onClick={e => this.onClickEditar(e, bio)}>
                        Editar
                      </a>
                    </TableCell>
                  </TableRow>
                  <TableRow>
                    ...
                    <TableCell className="userprofile-editar">
                      <a id="Invitacions" onClick={e => this.onClickEditar(e, invitacions)}>
                        Editar
                      </a>
                    </TableCell>
                  </TableRow>
          ...
          <Table>
            <TableBody>
              ...
              <TableRow>
                ...
                <TableCell>
                  <select onChange={value => this.setState({ newNode: value.nativeEvent.target.value })}>
                    {nodes ? (
                      nodes.map(value => (
                        <option key={value.nom} value={value}>
                          {value.nom}
                        </option>
                      ))
                    ) : (
  ...
  onGuardaCanvis() {
    this.props.postChanges({ prop: this.state.detall, value: this.state.newValue });
    this.setState({ open: false });
  }
}

const mapStateToProps = ({ user }) => {
  return { ...user.user, nodes: user.nodes };
};
