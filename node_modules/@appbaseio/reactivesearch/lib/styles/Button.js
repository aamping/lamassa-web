...
var filters = /*#__PURE__*/(0, _emotion.css)('margin:0 -3px;max-width:100%;a{margin:2px 3px;padding:5px 8px;font-size:0.85rem;position:relative;span:first-child{max-width:360px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;margin-right:26px;}span:last-child{display:flex;height:100%;top:0;right:8px;position:absolute;align-items:center;border-left:1px solid #fff;padding-left:8px;margin-left:8px;}&:hover,&:focus{span:first-child{text-decoration:line-through;}}}');
...
var primary = function primary(props) {
	return (/*#__PURE__*/(0, _emotion.css)('background-color:', props.theme.primaryColor, ';color:', props.theme.primaryTextColor, ';&:hover,&:focus{background-color:', (0, _utils.shade)(props.theme.primaryColor, -0.1), ';}')
	);
};
...
var disabled = /*#__PURE__*/(0, _emotion.css)('background-color:#fafafa;color:#ccc\n\tcursor:not-allowed;&:hover,&:focus{background-color:#fafafa;}');

var Button = /*#__PURE__*/(0, _reactEmotion2.default)('a', {
	target: 'css-19ogrg70'
})('display:inline-flex;justify-content:center;align-items:center;border-radius:3px;min-height:30px;word-wrap:break-word;padding:5px 12px;line-height:1.2rem;background-color:#eee;color:#424242;cursor:pointer;user-select:none;transition:all 0.3s ease;&:hover,&:focus{background-color:#ccc;}', function (props) {
