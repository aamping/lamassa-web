	...
	ReactiveList.prototype.render = function render() {
		...
		return _react2.default.createElement(
			...
			this.props.onAllData ? this.props.onAllData(results, streamResults, this.loadMore) : _react2.default.createElement(
				'div',
				{ className: (0, _helper.getClassName)(this.props.innerClass, 'list') },
...
var _initialiseProps = function _initialiseProps() {
	...
	this.prevPage = function () {
		if (_this2.state.currentPage) {
			_this2.setPage(_this2.state.currentPage - 1);
		}
	};

	this.nextPage = function () {
		if (_this2.state.currentPage < _this2.state.totalPages - 1) {
			_this2.setPage(_this2.state.currentPage + 1);
		}
	};

	this.getStart = function () {
		var midValue = parseInt(_this2.props.pages / 2, 10);
		var start = _this2.state.currentPage - midValue;
		return start > 1 ? start : 2;
	};

	this.renderPagination = function () {
		var start = _this2.getStart();
		var pages = [];

		if (start <= _this2.state.totalPages) {
			var totalPagesToShow = _this2.props.pages < _this2.state.totalPages ? start + _this2.props.pages - 1 : _this2.state.totalPages + 1;
			...
			var _loop = function _loop(i) {
				var pageBtn = _react2.default.createElement(
					_Button2.default,
					{
						...
						primary: _this2.state.currentPage === i - 1,
						key: i - 1,
				...
				if (i <= _this2.state.totalPages + 1) {
					pages.push(pageBtn);
				}
			};
		...
		if (!_this2.state.totalPages) {
			return null;
		}

		return _react2.default.createElement(
			'div',
			{ className: _Button.pagination + ' ' + (0, _helper.getClassName)(_this2.props.innerClass, 'pagination') },
			_react2.default.createElement(
				_Button2.default,
				{
					className: (0, _helper.getClassName)(_this2.props.innerClass, 'button') || null,
					disabled: _this2.state.currentPage === 0,
					onClick: _this2.prevPage
				},
				'Prev'
			),
			_react2.default.createElement(
				...
				{
					className: (0, _helper.getClassName)(_this2.props.innerClass, 'button') || null,
					primary: _this2.state.currentPage === 0,
					onClick: function onClick() {
						return _this2.setPage(0);
					}
				},
				'1'
			),
			...
			_react2.default.createElement(
				...
				{
					className: (0, _helper.getClassName)(_this2.props.innerClass, 'button') || null,
					disabled: _this2.state.currentPage >= _this2.state.totalPages - 1,
					onClick: _this2.nextPage
				},
				'Next'
			)
		);
	...
	this.handleSortChange = function (e) {
		...
		_this2.props.setQueryOptions(_this2.props.componentId, options);
	};
...
exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchtoProps)(ReactiveList);